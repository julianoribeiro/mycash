package br.com.vertexsoft.config.webflow;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = { "br.com.vertexsoft.mycash" }, //
scopedProxy = ScopedProxyMode.TARGET_CLASS, //
useDefaultFilters = false, //
includeFilters = { @Filter(Controller.class), @Filter(Configuration.class) })
